...
@Getter
@AllArgsConstructor
public class StartedServerPacket extends Packet {
    ...
    public StartedServerPacket() {
    }

    @Override
    public void write(ByteBuf byteBuf) {
        MessageSerializer messageSerializer = new MessageSerializer("startedServer");
    ...
    public void read(ByteBuf byteBuf) {
        ...
        try {
            MessageDeserializer messageDeserializer = new MessageDeserializer("startedServer");
